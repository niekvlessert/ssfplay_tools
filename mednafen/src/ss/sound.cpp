...
static uint64 ssfplay_native_samples;

#ifndef SSFPLAY_CAPTURE_WRITE
#define SSFPLAY_CAPTURE_WRITE(sample, address, value, size) ((void)0)
#endif
...
static MDFN_FASTCALL void SoundCPU_BusWrite(uint32 A, T V)
{
 ...
 SSFPLAY_CAPTURE_WRITE(ssfplay_native_samples, A & 0x1FFFFF, V, sizeof(T));
 SoundCPU.timestamp += 2;
}
...
static MDFN_FASTCALL void SoundCPU_BusRMW(uint32 A, uint8 (MDFN_FASTCALL *cb)(M68K*, uint8))
{
 ...
 SSFPLAY_CAPTURE_WRITE(ssfplay_native_samples, A & 0x1FFFFF, tmp, 1);
